              ...
              <ul class="nav pull-right">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="#">Government Office</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="span2">
            ...
            <nav>
              <ul class="quick-links">
                <li><a href="our_works.php">Popular Travel</a></li>
                <li><a href="patnerships.php">Popular Hotel</a></li>
                <li><a href="patnerships.php">Popular Restaurant & Food</a></li>
              <ul>
            </ul></ul></nav>          
          </div>
          <div class="span2">
