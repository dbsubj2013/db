...
<head>
  ...
  <body>
              ...
              <ul class="nav pull-right">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="#">Travel Place</a></li>
    ...
    <?php $out = mysqli_query($con,
      "SELECT idPlace, Place.name as PlaceName, Place.idPlace as id, Area.name as Area,AttractionType.AttractionTypeName as Type,address,url,pic
    ...
    <div class="content">
      <div class="container">
          ...
          <div class="page-header">
            <h1>Travel Place <i class="icon-briefcase"></i>    <small> Enjoy life with Bangkok.</small></h1>
          </div>
