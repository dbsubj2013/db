              ...
              <ul class="nav pull-right">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="#">Popular Restuarant & Food</a></li>
                  </ul>
                </li>
    ...
    <div class="content">
      <div class="container">
          ...
          <div class="page-header">
            <h1>Popular Restuarant & Food <i class="icon-star"></i>    <small>Taste and Place in the Bangkok</small></h1>
          </div>
          <div class="row">
          ...
          <div class="span2">
            ...
            <nav>
              <ul class="quick-links">
                <li><a href="pop_travel.php">Popular Travel</a></li>
                <li><a href="pop_hotel.php">Popular Hotel</a></li>
                <li><a href="#">Popular Restuarant & Food</a></li>
              <ul>
            </ul></ul></nav>          
          </div>
          <div class="span2">
