...
<head>
  ...
  <body>
    ...
    <!-- End: HEADER -->
    <!-- Start: MAIN CONTENT -->
   <?php $out = mysqli_query($con,"SELECT place.name as PlaceName,place.address,place.url,place.pic,area.name as Area ,RestaurantType.RestaurantTypeName as Type ,SUM(review.rating)/count(review.rating) as rating
FROM place,Restaurant,review,area,RestaurantType WHERE place.idPlace = Restaurant.idRestaurant and review.idPlace = place.idPlace and place.Area_id = area.idArea and Restaurant.type = RestaurantType.idRestaurantType group by place.idPlace order by rating desc ,ISNULL(place.pic), place.pic asc"
);?>
    <div class="content">
      <div class="container">
