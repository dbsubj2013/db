...
FROM place,Restaurant,review,area,RestaurantType WHERE place.idPlace = Restaurant.idRestaurant and review.idPlace = place.idPlace and place.Area_id = area.idArea and Restaurant.type = RestaurantType.idRestaurantType group by place.idPlace order by rating desc"
);?>
    <div class="content">
      <div class="container">
