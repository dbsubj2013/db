...
FROM place,Attraction,review,area,AttractionType WHERE place.idPlace = Attraction.idAttraction and review.idPlace = place.idPlace and place.Area_id = area.idArea and Attraction.type = AttractionType.idAttractionType group by place.idPlace order by rating desc"
);?>
    <div class="content">
      <div class="container">
